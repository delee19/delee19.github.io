...
var documents = [{
    ...
    "title": "About Me",
    "body": " Hi! I'm Dayna, nice to meet you! I was born and raised (briefly) in Los Angeles, and (mostly) Seoul. More recently in my life, I spent a few years in New York to study at Columbia University. I studied Computer Science on the Applications track, and recently graduated in December 2022 :D  Academically, I am particularly interested in Human-Computer Interaction (HCI), and Data Visualization, where I hope to illuminate meaningful, human experiences through data. I am also generally interested in Technology for social good, and how software can solve intriciate societal issues.  I'm a matcha aficiando, and I also enjoy experimenting with new cookie recipes (putting matcha powder in any recipe I find). In my free time, I can be also found playing TFT, or petting dogs. My ultimate adulting dream is to be put together enough to parent multiple golden retreivers one day, so I can address all of my petting needs 24/7. ContactFeel free to reach out through Email! All of my recent public coding endeavors are also on my Github . I am also reachable on LinkedIn for all of your direct messaging needs.   Resume"
    }, {
    "id": 2,
    ...
    "title": "Home",
    "body": "      Projects:                                                                                                     Powerful things you can do with the Markdown editor              :       There are lots of powerful things you can do with the Markdown editor. If you’ve gotten pretty comfortable with writing in Markdown, then you may enjoy some more advanced tips. . . :                                                                               Dayna                12 Jun 2018                                                                                                                                     The first mass-produced book to deviate from a rectilinear format              :       The first mass-produced book to deviate from a rectilinear format, at least in the United States, is thought to be this 1863 edition of Red Riding Hood, cut into the. . . :                                                                               Dayna                12 Jun 2018                                                                                                                                     Education must also train one for quick, resolute and effective thinking.               :       There are lots of powerful things you can do with the Markdown editor:                                                                                               12 Jun 2018                                                                                                                                     Accumulated experience of social living              :       The die cut has also been employed in the non-juvenile sphere as well, a recent example being Jonathan Safran Foer’s ambitious Tree of Codes. :                                                                               Dayna                12 Jun 2018                                                                                                                                     About Bundler                         1 2 3 4 5                      :       gem install bundler installs the bundler gem through RubyGems. You only need to install it once - not every time you create a new Jekyll project. Here are some additional. . . :                                                                               Dayna                12 May 2018                                                                                                                                     We all wait for summer                         1 2 3 4 5                      :       As I engage in the so-called “bull sessions” around and about the school, I too often find that most college men have a misconception of the purpose of education. Most. . . :                                                                                               12 Jan 2018                                               &laquo; Prev       1        2      Next &raquo; "
    }, {
    "id": 4,
    ...
    "title": "Home",
    "body": "{% if page. url == “/” and site. enable_featured != false%}       Featured:       {% for post in site. posts %}        {% include featuredbox. html %}      {% endfor %}  {% endif %}       Projects:         {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}    {% include pagination. html %}"
    }, {
    "id": 6,
